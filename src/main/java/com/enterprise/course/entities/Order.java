...
public class Order implements Serializable{
	...
	//Associacao 1 para 1 da classe independente mapeada pelo nome do atributo colocada na classe dependente ou seja "order"
	//cascade = CascadeType.ALL colocamos porque queremos que a classe dependente assuma sempre o mesmo id da classe independente no relacionamento 1 para 1 muitas vezes isso acontece e define-se assim
