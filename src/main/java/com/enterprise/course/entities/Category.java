...
public class Category implements Serializable{//Serializable transforma os dados em bytes para transferencias dos dados na rede, transferencia para ficheiros etc.
